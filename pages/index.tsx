          ...
          <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
            <header className="flex justify-between items-center py-4 md:py-8 mb-8 md:mb-12 xl:mb-16">
              ...
              <Link href="/" className="inline-flex items-center text-black-800 text-2xl md:text-3xl font-bold gap-2.5" aria-label="logo">
                <Image src={`/img/logo-genero.png`} width={145} height={57} alt="Genero Pharmaceuticals" />
              </Link>
              {/* <!-- logo - end --> */}

              {/* <!-- nav - start --> */}
              <nav className="hidden lg:flex gap-12">
                <Link href="/" className="text-two500 text-lg font-semibold">
                  Home
                </Link>
                <Link
                  href="/dashboard"
                  target="_blank"
                  className="text-gray-600 hover:text-two500 active:text-indigo-700 text-lg font-semibold transition duration-100">
                  Dashboard
                </Link>
                <Link
                ...
                <Link href="/about" className="text-gray-600 hover:text-two500 active:text-indigo-700 text-lg font-semibold transition duration-100">
                  About
                </Link>
              </nav>
              {/* <!-- nav - end --> */}
              ...
              {/* <!-- buttons - start --> */}
              <Link
                href="https://api.whatsapp.com/send?phone=6285716904705"
                target="_blank"
            ...
            <section className="flex flex-col lg:flex-row justify-between gap-6 sm:gap-10 md:gap-16 mb-8 md:mb-16">
              ...
              <div className="xl:w-5/12 flex flex-col justify-center sm:text-center lg:text-left lg:py-12">
                <p className="text-two500 md:text-lg xl:text-xl font-semibold mb-4 md:mb-6">Very proud to introduce</p>
                ...
                <div className="flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5">
                  <a
                    href="#"
                    className="inline-block bg-two500 hover:bg-one800 focus-visible:ring ring-indigo-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">
                    Start now
                  </a>
              ...
              <div className="xl:w-5/12 h-48 lg:h-96 bg-gray-100 overflow-hidden shadow-lg rounded-lg">
                <Image
                  src="/img/genero-pharmaceuticals.jpg"
                  loading="lazy"
            ...
            <section className="flex flex-col lg:flex-row justify-between items-center border-t gap-10 lg:gap-8 pt-8">
              ...
              <div className="grid grid-cols-2 md:flex md:divide-x gap-4 -mx-6 md:-mx-8">
                <div className="px-6 md:px-8">
                  <span className="block text-two500 text-lg md:text-xl font-bold text-center md:text-left">200</span>
                  <span className="block text-gray-800 text-sm md:text-base font-semibold text-center md:text-left">People</span>
                </div>

                <div className="px-6 md:px-8">
                  <span className="block text-two500 text-lg md:text-xl font-bold text-center md:text-left">500+</span>
                  <span className="block text-gray-800 text-sm md:text-base font-semibold text-center md:text-left">Projects</span>
                </div>

                <div className="px-6 md:px-8">
                  <span className="block text-two500 text-lg md:text-xl font-bold text-center md:text-left">250+</span>
                  <span className="block text-gray-800 text-sm md:text-base font-semibold text-center md:text-left">Customers</span>
                </div>

                <div className="px-6 md:px-8">
                  <span className="block text-two500 text-lg md:text-xl font-bold text-center md:text-left">A couple</span>
